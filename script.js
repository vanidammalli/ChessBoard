...
let main = {
    variables: {
      ...
      pieces: {
        w_king: {
          position: '5_1',
          img: `<img class='allimg allpawn' src="./Images/Wking.png" alt="">`,
          captured: false,
          moved: false,
          type: 'w_king'
        ...
        w_queen: {
          position: '4_1',
          img: `<img class='allimg allpawn' src="./Images/Wqueen.png" alt="">`,
          captured: false,
          moved: false,
          type: 'w_queen'
        },
        w_bishop1: {
          position: '3_1',
          img: `<img class='allimg allpawn' src="./Images/Wbishop.png" alt="">`,
          captured: false,
          moved: false,
          type: 'w_bishop'
        },
        ...
        w_knight1: {
          position: '2_1',
          img: `<img class='allimg allpawn' src="./Images/Wknight.png" alt="">`,
          captured: false,
          moved: false,
          type: 'w_knight'
        },
        ...
        w_rook1: {
          position: '1_1',
          img: `<img class='allimg allpawn' src="./Images/Wrook.png" alt="">`,
          captured: false,
          moved: false,
          type: 'w_rook'
        },
        ...
        w_pawn1: {
          position: '1_2',
          img: `<img class='allimg allpawn' src="./Images/Wpawn.png" alt="">`,
          captured: false,
          type: 'w_pawn',
          moved: false
        },
        ...
        b_king: {
          position: '5_8',
          img: `<img class='allimg allpawn' src="./Images/Bking.png" alt="">`,
          captured: false,
          moved: false,
          type: 'b_king'
        },
        b_queen: {
          position: '4_8',
          img: `<img class='allimg allpawn' src="./Images/Bqueen.png" alt="">`,
          captured: false,
          moved: false,
          type: 'b_queen'
        },
        b_bishop1: {
          position: '3_8',
          img: `<img class='allimg allpawn' src="./Images/Bbishop.png" alt="">`,
          captured: false,
          moved: false,
          type: 'b_bishop'
        },
        ...
        b_knight1: {
          position: '2_8',
          img: `<img class='allimg allpawn' src="./Images/Bknight.png" alt="">`,
          captured: false,
          moved: false,
          type: 'b_knight'
        },
        ...
        b_rook1: {
          position: '1_8',
          img: `<img class='allimg allpawn' src="./Images/Brook.png" alt="">`,
          captured: false,
          moved: false,
          type: 'b_rook'
        },
        ...
        b_pawn1: {
          position: '1_7',
          img: `<img class='allimg allpawn' src="./Images/Bpawn.png" alt="">`,
          captured: false,
          type: 'b_pawn',
          moved: false
        },
    ...
    methods: {
      ...
      options: function(startpoint, coordinates, piecetype) { // first check if any of the possible coordinates is out of bounds;
        ...
        console.log(piecetype, coordinates, 'piecetype')
        switch (piecetype) {
          ...
          case 'w_pawn':
              ...
              coordinates = coordinates.filter(val => {
                ...
                if (coordinate[0] < sp.x || coordinate[0] > sp.x){ // if the coordinate is on either side of the center, check if it has an opponent piece on it;
                  console.log(coordinate,$('#' + val), $('#' + val).attr('chess'), sp, 'inside coordinate')
